 ...
 /* global opera, java, Base64, _GET*/
  ...
  !function (global, factory) {
    ...
    xyplayer.prototype = {
        ...
        init: function (c) {
            ...
            switch (this.tp) {
                ...
                try {
                    ...
                    xyplay.listname=this.wd;
                    $(this.logo).hide();
                    xyplay.getvideo('wd',this.wd,false,xyplay);
                    break;
                } catch (error) {
        ...
        /*   内部函数：输出 高亮调试信息  */
        onVer: function () {
            var message = "XyPlayer X3 by http://xydai.cn";
            if (typeof console === 'object') {
                console.log("\n %c XyPlayer X3 %c http://xydai.cn \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;");
        ...
        tipstime: function () {
            if (!$($this.playad).is(':hidden')) {
                ...
                if (this.count >= 20) {
                    this.echo("<span style='color:#f90;'>解析响应超时，请刷新重试！</span>", false, false, this.playad);
                } else {
                    this.count += 1;
                    setTimeout(function () {
                        $this.tipstime();
